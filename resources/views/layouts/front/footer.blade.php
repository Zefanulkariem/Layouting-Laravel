                ...
                <div class="col-xl-6 col-lg-8 col-md-8 col-sm-6">
                   <div class="footer-cta__source">
                      ...
                      <div class="footer-cta__source-thumb">
                         <a href="#"><img src="{{asset('front/assets/img/footer/f-google.jpg')}}" alt="google"></a>
                         <a href="#"><img src="{{asset('front/assets/img/footer/f-app.jpg')}}" alt="app"></a>
                      </div>
                   </div>
                </div>
             </div>
             ...
             <div class="row">
                ...
                <div class="col-xl-6 col-lg-5 col-md-7 col-sm-12">
                   <div class="footer-copyright__brand">
                      <img src="{{asset('front/assets/img/footer/f-brand-icon-01.png')}}" alt="footer-brand">
                   </div>
                </div>
             </div>
          </div>
