    ...
    <div class="container">
       <div class="tpabout__inner-logo p-relative">
          ...
          <div class="tpabout__logo">
             <a href="{{url('/')}}"><img src="{{asset('front/assets/img/banner/about-img-3.png')}}" alt=""></a>
          </div>
       </div>
       <div class="row">
          <div class="col-sm-12">
       ...
       <div class="row align-items-center">
          ...
          <div class="col-lg-6 col-md-12 col-sm-12">
             <div class="tpabout__inner-title-area about-inner-content ml-50 mr-50 mb-70">
                ...
                <a class="tpteam__btn" href="{{url('contact')}}">Get In Touch</a>
             </div>
          </div>
       </div>
       <div class="row align-items-center">
          <div class="col-lg-6 col-md-12 col-sm-12">
             <div class="tpabout__inner-title-area about-inner-content mr-100 mb-70">
                ...
                <a class="tpteam__btn" href="{{url('contact')}}">Contact With Us</a>
             </div>
          </div>
          <div class="col-lg-6 col-md-12 col-sm-12">
             <div class="tpfeature__inner-thumb mb-70">
